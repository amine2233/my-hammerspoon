...
hs.hotkey.bind(mash, "W", function()
    hs.notify.new({title="Hammerspoon", informativeText="Hello Amine Bensalah"}):send()
end)
...
if spoon.WinWin then
    local winMode = hs.hotkey.modal.new(mash,"w")
    function winMode:entered() hs.alert'Entered WinWin' end
    function winMode:exited() hs.alert'Exited WinWin' end
    hs.hotkey.bind(mash, 'h', 'Move Leftward', function() spoon.WinWin:stepResize("left") end, nil, function() spoon.WinWin:stepResize("left") end)
    hs.hotkey.bind(mash, 'l', 'Move Rightward', function() spoon.WinWin:stepResize("right") end, nil, function() spoon.WinWin:stepResize("right") end)
    hs.hotkey.bind(mash, 'k', 'Move Upward', function() spoon.WinWin:stepResize("up") end, nil, function() spoon.WinWin:stepResize("up") end)
    hs.hotkey.bind(mash, 'j', 'Move Downward', function() spoon.WinWin:stepResize("down") end, nil, function() spoon.WinWin:stepResize("down") end)
    hs.hotkey.bind(mash, 'left', 'Lefthalf of Screen', function() spoon.WinWin:moveAndResize("halfleft") end)
    hs.hotkey.bind(mash, 'right', 'Righthalf of Screen', function() spoon.WinWin:moveAndResize("halfright") end)
    hs.hotkey.bind(mash, 'up', 'Uphalf of Screen', function() spoon.WinWin:moveAndResize("halfup") end)
    hs.hotkey.bind(mash, 'down', 'Downhalf of Screen', function() spoon.WinWin:moveAndResize("halfdown") end)
    hs.hotkey.bind(mash, 'f', 'Fullscreen', function() spoon.WinWin:moveAndResize("fullscreen") end)
    hs.hotkey.bind(mash, 'c', 'Center Window', function() spoon.WinWin:moveAndResize("center") end)
    hs.hotkey.bind(mash, '=', 'Stretch Outward', function() spoon.WinWin:moveAndResize("expand") end, nil, function() spoon.WinWin:moveAndResize("expand") end)
    hs.hotkey.bind(mash, '-', 'Shrink Inward', function() spoon.WinWin:moveAndResize("shrink") end, nil, function() spoon.WinWin:moveAndResize("shrink") end)
    hs.hotkey.bind(mash, 'Y', 'NorthWest Corner', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("cornerNW") end)
...
----------------------------------------------------------------------------------------------------
-- Register Hammerspoon Wifi Notification
...
----------------------------------------------------------------------------------------------------
-- Register Hammerspoon MouseCircle
if spoon.MouseCircle then
    hsmouseshow_keys = hsmouseshow_keys or {"alt", "M"}
    if string.len(hsaclock_keys[2]) > 0 then
        spoon.ModalMgr.supervisor:bind(hsmouseshow_keys[1],hsmouseshow_keys[2], "Show mouse", function ()
